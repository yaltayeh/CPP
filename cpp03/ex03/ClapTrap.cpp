...
/*   Updated: 2025/09/21 14:37:57 by yaltayeh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("Default_ClapTrap"),
					   hitPoints(10),
					   energyPoints(10),
					   attackDamage(0)
{
	std::cout << "ClapTrap {Default_ClapTrap}: Default constructor called!" << std::endl;
}
